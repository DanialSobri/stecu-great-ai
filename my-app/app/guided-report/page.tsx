            ...
            <CardContent className="p-6">
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <Button
                        ...
                        variant="outline"
                        className={cn(
                          "border-purple-200 hover:bg-purple-50 bg-transparent w-full sm:w-auto",
                  ...
                  {description.length >= 20 && !isListening && (
                    <div className="text-center">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-gradient-to-r from-slate-50 to-purple-50/50 p-5 rounded-xl border border-slate-200">
                              <div className="prose prose-sm max-w-none text-slate-700">
                                <div className="space-y-4">
                                  {(() => {
                                    // Parse the AI summary to extract incident_overview and key_observation
                                    const overviewMatch = aiSummary.match(/<incident_overview>([\s\S]*?)<\/incident_overview>/)
                                    const observationMatch = aiSummary.match(/<key_observation>([\s\S]*?)<\/key_observation>/)
                                    
                                    const overview = overviewMatch ? overviewMatch[1].trim() : 'No incident overview available'
                                    const observations = observationMatch ? observationMatch[1].trim() : 'No key observations available'
              ...
              {/* Navigation Buttons */}
              {currentStep < 4 && (
                <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mt-8 pt-6 border-t border-slate-200">
                  <Button
                    variant="outline"
                    onClick={prevStep}
                    disabled={currentStep === 1}
                    className="border-slate-300 text-slate-600 hover:bg-slate-50 bg-transparent w-full sm:w-auto order-2 sm:order-1"
                  >
                  ...
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white shadow-lg hover:shadow-xl transition-all duration-200 w-full sm:w-auto order-1 sm:order-2"
                  >
                    {currentStep === 3 ? (
                      <>
                        <Brain className="w-4 h-4 mr-2" />
